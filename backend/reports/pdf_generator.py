...
class PDFReportGenerator:
    ...
    def generate_pdf_bytes(cls, incident: Dict[str, Any]) -> bytes:
        ...
        elements.append(Paragraph("🛡️ PHAGEGUARD — PHISHING INCIDENT INVESTIGATION REPORT", title_style))
        ...
        elements.append(Paragraph("CONFIDENTIAL &bull; Generated by PHAGEGUARD — AI-Powered Phishing Investigation & SOC Response Platform &bull; For Authorized Security Operations Personnel Only", subtitle_style))
