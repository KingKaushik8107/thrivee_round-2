    ...
    def generate_json_report(cls, incident_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "report_metadata": {
                ...
                "generator": "PhishX — AI-Powered Phishing Investigation & SOC Response Platform v1.0",
...
<body>
    <div class="container">
        <div class="header">
            <div>
                <div class="logo">🛡️ PhishX — CYBERSECURITY INCIDENT DOSSIER</div>
        ...
        <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 11px; color: #94a3b8; text-align: center;">
            Generated automatically by PhishX — AI-Powered Phishing Investigation & SOC Response Platform &bull; Confidential Incident Documentation &bull; For Authorized SOC Personnel Only
        </div>
    </div>
</body>
</html>
